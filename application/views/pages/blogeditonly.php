...
<div class="col-md-8 mt-5">
   ...
   <form enctype="multipart/form-data" method='post' action="/doeditable/<?php echo $blogpost->id;?>">
         <div class="form-row">
         <div class="form-group col-md-4">
            <label for="inputEmail4">Blog title</label>
            <input type="text" value="<?= $blogpost->title;?>" name="blog_title" class="form-control" id="validationCustom03">
         </div>
         <div class="col-md-6 mt-5">
            <small class='p_validate' style="color:red;"><?php echo form_error('blog_title'); ?> </small> 
         </div>
      </div>
      <div class="form-group">
         ...
         <textarea name="blogtextarea"><?= $blogpost->description; ?></textarea>
         <script>
      ...
      <div class="form-row">
         <div class="form-group col-md-6">
            ...
            <small style="color:red;"><?php echo form_error('profile_image'); ?> </small>
            <input id="imgInp" type="file" name='profile_image' onchange="readURL(this)" class="form-control-file" >
         </div>
         <div class="form-group col-md-6">
            <div class="form-group">
               <label for="exampleFormControlFile1"></label>
               <img class="float-left" id="blah" src="<?php echo base_url()."/images/".$blogpost->imagepath;  ?>" />
               <input type="hidden" name="oldimagename" value="<?= $blogpost->imagepath; ?>"/>
            </div>
         </div>
      </div>
      <div class="form-group col-md-6">
