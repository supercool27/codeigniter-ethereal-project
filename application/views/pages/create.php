...
<div class="form-group col-md-6">
    ...
    <input checked value=1 class="form-check-input" type="radio" name="status" id="flexRadioDefault1">
    <label class="form-check-label" for="flexRadioDefault1">
      Show
    </label>
    </div>
...
<div class="form-group col-md-6">  
  <div class="form-check">
  <input value='2' class="form-check-input" type="radio" name="status" id="flexRadioDefault2" >
